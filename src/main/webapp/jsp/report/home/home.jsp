...
<jsp:useBean id="ctx" type="org.dal.cat.report.page.home.Context" scope="request"/>
<jsp:useBean id="payload" type="org.dal.cat.report.page.home.Payload" scope="request"/>
<jsp:useBean id="model" type="org.dal.cat.report.page.home.Model" scope="request"/>
<a:home>
