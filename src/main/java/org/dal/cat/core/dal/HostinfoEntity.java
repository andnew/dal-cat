...
public class HostinfoEntity {
   ...
   public static final Readset<Hostinfo> READSET_FULL = new Readset<Hostinfo>(ID, IP, DOMAIN, HOSTNAME, CREATION_DATE, LAST_MODIFIED_DATE);

   public static final Updateset<Hostinfo> UPDATESET_FULL = new Updateset<Hostinfo>(ID, IP, DOMAIN, HOSTNAME, LAST_MODIFIED_DATE);
